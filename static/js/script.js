...
function intialize(number_of_guesses, number_of_chars) {

    // Create the game board
    for (let r = 0; r < number_of_guesses; r++) {
        for (let c = 0; c < number_of_chars; c++) {
            // <span id="0-0" class="tile">P</span>
            let char_box = document.createElement("span");
            char_box.id = r.toString() + "-" + c.toString();
            char_box.classList.add("char_box");
            char_box.innerText = "";
            document.getElementById("game-board").appendChild(char_box);
        }
    }
